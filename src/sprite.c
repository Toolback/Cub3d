...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/06 22:45:32 by jurenaul          #+#    #+#             */
/*   Updated: 2023/08/07 20:26:15 by jurenaul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned int	ft_spixel(t_data *s, int index, unsigned int col)
{
	int	t;
	int	r;
	int	g;
...
void			ft_sdraw(t_data *s, int loc, double dist)
{
	unsigned int	col;
	double			size;
	int				index;
...
void			ft_slocate(t_data *s, double dirx, double diry, double dist)
{
	double	angle;
